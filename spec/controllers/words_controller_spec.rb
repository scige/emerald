...
describe WordsController do
  ...
  let(:valid_attributes) { { "right" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved word as @word" do
        ...
        post :create, {:word => { "right" => "invalid value" }}, valid_session
        assigns(:word).should be_a_new(Word)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested word" do
        ...
        Word.any_instance.should_receive(:update_attributes).with({ "right" => "MyString" })
        put :update, {:id => word.to_param, :word => { "right" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the word as @word" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Word.any_instance.stub(:save).and_return(false)
        put :update, {:id => word.to_param, :word => { "right" => "invalid value" }}, valid_session
        assigns(:word).should eq(word)
      end
